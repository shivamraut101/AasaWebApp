    ...
    public partial class contribute : System.Web.UI.Page
    {
        ...
        void addProduct()
        {
            try
            {
                ...
                conn.Open();
                String query = "INSERT INTO product_tbl(Name,Detail,Cost_Price,MRP,Current_Stock,Image1,Image2,Image3,Category,Contributor,user_id) values('" + TextBox2.Text.Trim() + "','" + TextBox6.Text.Trim() + "','" + TextBox10.Text.Trim() + "','" + TextBox1.Text.Trim() + "','" + TextBox4.Text.Trim() + "',@Image1,@Image2,@Image3,'" + ListBox1.Text.Trim() + "','" + TextBox3.Text.Trim() + "','" + TextBox8.Text.Trim() +"')";
        ...
        protected void Button4_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string query = "SELECT * FROM product_tbl WHERE user_id=@sessionUser AND ID=@ID";
                SqlCommand cmd = new SqlCommand(query, con);
                cmd.Parameters.AddWithValue("@ID", TextBox7.Text.Trim());
                cmd.Parameters.AddWithValue("@sessionUser", TextBox8.Text.Trim());
                SqlDataAdapter da = new SqlDataAdapter(cmd);
                DataTable dt = new DataTable();
                da.Fill(dt);
                if (dt.Rows.Count >= 1)
        ...
        //Contributor Product On Load
        void contributor_Product()
        {
            try
            {
                SqlConnection con = new SqlConnection(strcon);
